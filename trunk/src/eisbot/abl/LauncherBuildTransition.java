...
-Xmx512M 
 */
public class LauncherBuildTransition { 
  
	public static void main(String[] args) {   
   
		String botName = "ProtossBuildTransitionBot";		  
//		String botName = "EISBotAAAI";		  
		System.setProperty("ABLBotName", botName);   
//		System.setProperty("BuildOrderScript", "src/eisbot/buildorder/builds/CorsairTemplar.txt");
